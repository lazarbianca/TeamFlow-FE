...
export default function TeamDetailsScreen() {
  ...
  // DISABLE IF BUSY OR ALREADY REQUESTED
  const isJoinDisabled = !team || team.status !== "available" || hasAlreadyRequested;

  const handleJoin = () => {
    if (isJoinDisabled || !team || !teamId) return;

    // Add to global state so it stays disabled across the session!
...
// ... [Keep exactly the same styles object as you had before] ...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: PURPLE },
  hero: { paddingTop: 18, paddingBottom: 18, paddingHorizontal: 20, backgroundColor: PURPLE },
  backButton: { position: "absolute", left: 10, top: 10, width: 44, height: 44, borderRadius: 22, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(255,255,255,0.15)", zIndex: 10, elevation: 10 },
  heroRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingTop: 44 },
  heroTitle: { flex: 1, fontSize: 46, lineHeight: 52, fontWeight: "500", color: "#fff", marginRight: 16, fontFamily: "serif" },
  heroAvatarWrap: { width: 64, height: 64, borderRadius: 16, overflow: "hidden", backgroundColor: "rgba(255,255,255,0.18)" },
  ...
  scroll: { flex: 1 },
  joinBar: { paddingHorizontal: 20, paddingTop: 12, paddingBottom: 16, borderTopWidth: 1, borderTopColor: "#E5E7EB", backgroundColor: "#fff" },
  joinButton: { height: 52, borderRadius: 14, alignItems: "center", justifyContent: "center", backgroundColor: PURPLE },
  joinButtonDisabled: { backgroundColor: "#D1D5DB" },
  joinButtonText: { color: "#fff", fontSize: 18, fontWeight: "900", letterSpacing: 0.2 },
  joinButtonTextDisabled: { color: "#6B7280" },
  joinHint: { marginTop: 10, fontSize: 13, fontWeight: "600", color: "#6B7280", textAlign: 'center' },
  pageTitle: { fontSize: 18, fontWeight: "800", color: PURPLE },
  pageSubtitle: { marginTop: 6, fontSize: 13, color: "#6B7280", fontWeight: "600" },
  portfolioRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 16 },
  portfolioLabel: { fontSize: 22, fontWeight: "800", color: "#9CA3AF", letterSpacing: 0.5 },
  statsRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  statPill: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 14, borderWidth: 1, borderColor: "#D1C4DB", backgroundColor: "#F6F0FA" },
  statPillText: { fontSize: 15, fontWeight: "800", color: "#374151" },
  card: { backgroundColor: "#FBF5FF", borderRadius: 12, padding: 16, marginBottom: 16 },
  cardTitle: { fontSize: 22, fontWeight: "900", color: "#9CA3AF", marginBottom: 12, letterSpacing: 0.5 },
  skillPillsRow: { flexDirection: "row", flexWrap: "wrap", gap: 10 },
  skillPill: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 14, borderWidth: 1, borderColor: "#C8C3CF", backgroundColor: "#F7F1FB" },
  ...
  achievementSubtitle: { marginTop: 4, fontSize: 18, fontWeight: "500", color: "#374151" },
  projectsList: { gap: 16 },
  projectRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 },
  projectRowDivider: { paddingTop: 12 },
  projectTextWrap: { flex: 1 },
  projectName: { fontSize: 20, fontWeight: "900", color: "#111827" },
  projectMeta: { marginTop: 6, fontSize: 18, fontWeight: "500", color: "#374151" },
  projectRatingPill: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 14, borderWidth: 1, borderColor: "#C8C3CF", backgroundColor: "#F7F1FB" },
