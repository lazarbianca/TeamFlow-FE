            ...
            { id: "dm4", otherUserId: "4", unreadCount: 0, messages: [] },
      {
        ...
        sharedFiles: [
            ...
            },
            {
                ...
                content: 'Notes from Sync (10/20/26):\n\n1. Alex will take over the chat UI.\n2. Jordan needs to finalize the backend API by Friday.\n3. The client requested a darker shade of purple for the buttons.'
            },
            {
                id: "f3",
